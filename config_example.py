...
browser = ["Chrome"]
# ⚠️ FICHIER EXEMPLE - NE PAS UTILISER DIRECTEMENT
# Copiez ce fichier vers config.py et remplissez avec vos vraies informations
# Ou mieux : utilisez le nouveau système config.json + .env

# Identifiants Linkedin (À NE JAMAIS COMMITER!)
